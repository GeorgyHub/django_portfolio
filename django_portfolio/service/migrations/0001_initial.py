    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('update_at', models.DateTimeField(auto_now=True, verbose_name='Обновлено')),
                ('name_abulm', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='service.abulm', verbose_name='Название альбома')),
        ...
        migrations.AddField(
            model_name='abulm',
            name='name_band',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='service.bands', verbose_name='Название группы'),
        ),
    ]
